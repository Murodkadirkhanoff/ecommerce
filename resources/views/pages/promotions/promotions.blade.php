<x-layout>
    <main>
        ...
        <section class="bg-dark align-items-center d-flex"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Title -->
                        <h1 class="text-white">Список акций</h1>
                        <!-- Breadcrumb -->
                        <div class="d-flex">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                    <li class="breadcrumb-item"><a href="{{url('/')}}">Главная</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Список акций</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        Page Banner END -->
    @php
        $current = $promotions->currentpage()*$promotions->perpage();

       if ($promotions->total() < $current){
           $current = $promotions->total();
       }
    @endphp
    <!-- =======================
        Page content START -->
        <section class="pb-0 py-sm-5">
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    <!-- Content -->
                    <div class="col-md-4">
                        <h4 class="my-2">Показано с {{($promotions->currentpage()-1)*$promotions->perpage()+1}}
                            по {{$current}}
                            из {{$promotions->total()}} записей
                        </h4>
                            ...
                            <!-- Card list START -->
                                <div class="col-12">
                                    <div class="card shadow p-2">
                                        <div class="row g-0">
                                            <div class="col-md-3">
                                                <img src="{{env('MEDIA_URL') . $promotion->image}}" style="height: 300px; width:100%; object-fit:cover" class="rounded-2"
                                                     alt="Card image">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <!-- Badge -->
                                                        <a href="#"
                                                           class="badge bg-primary text-white mb-2 mb-sm-0">{{$promotion->created_at->diffForHumans()}}</a>
                                                        <!-- Rating and wishlist -->
                                                    </div>

                                                    <!-- Title -->
                                                    <h5 class="card-title mb-4"><a
                                                            href="{{route('promotions.show', $promotion->id)}}">{{$promotion->title}}</a>
                                                    </h5>

                                                    <!-- Info -->
                                                    <ul class="list-inline">
                                                        <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                                class="far fa-clock text-danger me-2"></i>{{$promotion->end}}
                                                        </li>
                                                        @if($promotion->promotion_type != 'others')
                                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                                    class="fas fa-table text-orange me-2"></i>{{$promotion->promotion_value}}
                                                                % скидка
                                                            </li>@endif
                                                        <li class="list-inline-item h6 fw-light"><i
                                                                class="fas fa-signal text-success me-2"></i>{{getPromotionTypeText($promotion->promotion_type)}}
                                                        </li>
                                                    </ul>

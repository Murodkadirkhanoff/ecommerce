<x-layout>
    <main>
        ...
        <section class="bg-dark align-items-center d-flex"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Title -->
                        <h1 class="text-white">Список публикации</h1>
                        <!-- Breadcrumb -->
                        <div class="d-flex">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                    <li class="breadcrumb-item"><a href="{{url('/')}}">Главная</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Список публикации</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        Page Banner END -->
    @php
        $current = $posts->currentpage()*$posts->perpage();

       if ($posts->total() < $current){
           $current = $posts->total();
       }
    @endphp
    <!-- =======================
        ...
        <section class="pb-0 py-sm-5">
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    <!-- Content -->
                    <div class="col-md-4">
                        <h4 class="my-2">Показано с {{($posts->currentpage()-1)*$posts->perpage()+1}}
                            по {{$current}}
                            ...
                            <!-- Card list START -->
                                <div class="col-12">
                                    <div class="card shadow p-2">
                                        <div class="row g-0">
                                            <div class="col-md-3">
                                                <img src="{{env('MEDIA_URL') . $post->image}}" style="width: 100%; height: 200px; object-fit: cover" class="rounded-2"
                                                     alt="Card image">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <!-- Badge -->
                                                        <a href="#"
                                                           class="badge bg-primary text-white mb-2 mb-sm-0">{{$post->created_at->diffForHumans()}}</a>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mt-3 mt-sm-0">
                                                            <a href="{{route('posts.show', $post->id)}}" class="btn btn-dark">Посмотреть больше</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
